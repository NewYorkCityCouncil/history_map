...
import { YEARS, getVariablesForYear, getRaceGroupLabel } from "../config/variablesByYear.ts";
...
export interface ControlPanelProps {
  ...
  onVarChange: (v: SelectableVar) => void;
}
    ...
    <div className="control-panel">
      ...
      <div className="control-group">
        ...
        <select
          ...
          value={selectedVar}
          onChange={(e) => onVarChange(e.target.value as SelectableVar)}
        >
